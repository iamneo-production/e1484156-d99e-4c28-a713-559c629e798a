...
export class AddonService {
  ...
  AddAddOn(AddOnDetail: any) {
    (this.http.post('https://8080-cadcffeefefcdaedafbaaabdbdcfdaefedccc.project.examly.io/admin/addAddOn', AddOnDetail).subscribe(Response => {
  ...
  GetAddOn(cb: CallBackFunction) {
    this.http.get('https://8080-cadcffeefefcdaedafbaaabdbdcfdaefedccc.project.examly.io/admin/getAddOn').subscribe((response) => {
      cb(response);
    });
  }
  ...
  GetAddOnById(AddOnId: number, cb: CallBackFunction) {
    this.http.get('https://8080-cadcffeefefcdaedafbaaabdbdcfdaefedccc.project.examly.io/admin/getAddOn/' + AddOnId).subscribe(
      (response) => {
        cb(response);
      }
    );
  ...
  EditAddOn(ActualAddOnDetails: any, EditedAddOnDetails: any) {
    (this.http.put('https://8080-cadcffeefefcdaedafbaaabdbdcfdaefedccc.project.examly.io/admin/editAddOn/' + ActualAddOnDetails.addOnId,
      {
  ...
  DeleteAddOn(AddOnDetails: any) {
    this.http.delete('https://8080-cadcffeefefcdaedafbaaabdbdcfdaefedccc.project.examly.io/admin/deleteAddOn/'+AddOnDetails.addOnId).subscribe(response => {
